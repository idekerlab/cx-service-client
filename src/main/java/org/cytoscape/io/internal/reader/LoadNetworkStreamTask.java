...
import org.cytoscape.io.internal.reader.AbstractLoadNetworkTask;
...
public class LoadNetworkStreamTask extends AbstractLoadNetworkTask {
	...
	public LoadNetworkStreamTask(
		...
		super(netmgr, networkViewManager, props, namingUtil, vmm, nullNetworkViewFactory, serviceRegistrar);
